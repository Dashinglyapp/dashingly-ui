			...
			build_index:{ // adds all our app's css and js files to index.html
				...
				options:{
					process:function(content){ //content, srcpath
						...
						var newContent = content.replace(/\t<\!-- token_replace_css_here -->/i,cssStr);
						return newContent;
					}
				}
			},
...
// node_modules/grunt-protractor-runner/node_modules/protractor/bin/webdriver-manager update
		...
		shell: {
			...
			selenium: { // starts the selenium server to run tests.
	...
	// grunt dev to prevent restarting the server on each test.
