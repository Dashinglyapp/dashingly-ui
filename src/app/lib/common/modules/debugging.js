define(['angularAMD', 'realize-sync', 'lodash', 'realize-lodash'],
	function (angularAMD) {
		var module = angular.module('realize-debugging', ['ng', 'realize-sync', 'realize-lodash']);
		module.factory("debugging", ['$templateCache', '$rootScope', '_', function ($templateCache, $rootScope, _) {
			return {
