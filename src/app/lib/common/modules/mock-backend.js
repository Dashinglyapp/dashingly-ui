define(
	['angularAMD',
		...
		'realize-lodash'],
	function (angularAMD) {
		var module = angular.module('realize-mock-backend', ['angularMockE2E', 'realize-sync', 'realize-debugging', 'realize-lodash'])
		.factory('realizeMockData', ['_', function (_) {
			return {
		...
		.run(['user', 'widget', '$httpBackend', 'realizeMockData', '_', function (user, widget, $httpBackend, mocks, _) {
			...
			$httpBackend.whenGET(/\/api\/v1\/login/)
				.respond(function (url, data, headers) {
					return ret.authed({
						data: data,
						success: {"csrf_token": null, "fields": [
							{"current_token": null, "data": null, "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "csrf_token", "label": {"field_id": "csrf_token", "text": "Csrf Token"}, "name": "csrf_token", "process_errors": [], "short_name": "csrf_token", "type": "CSRFTokenField", "widget": "hidden"},
							{"data": false, "default": false, "description": "", "errors": [], "filters": [], "flags": {}, "id": "remember", "label": {"field_id": "remember", "text": "Remember Me"}, "name": "remember", "process_errors": [], "short_name": "remember", "type": "BooleanField", "widget": "checkbox"},
							{"data": false, "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "submit", "label": {"field_id": "submit", "text": "Login"}, "name": "submit", "process_errors": [], "short_name": "submit", "type": "SubmitField", "widget": "submit"},
							{"data": null, "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "next", "label": {"field_id": "next", "text": "Next"}, "name": "next", "process_errors": [], "short_name": "next", "type": "HiddenField", "widget": "hidden"},
							{"data": null, "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "password", "label": {"field_id": "password", "text": "Password"}, "name": "password", "process_errors": [], "short_name": "password", "type": "PasswordField", "widget": "password"},
							{"data": null, "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "email", "label": {"field_id": "email", "text": "Email Address"}, "name": "email", "process_errors": [], "short_name": "email", "type": "TextField", "widget": "text"}
						] }
					});
				});
			...
			$httpBackend.whenPOST(/\/api\/v1\/login/)
				.respond(function (url, data, headers) {
					if (mocks.user.authenticated) {
						return ret.fail({"csrf_token": null, "fields": [
							{"current_token": null, "data": "", "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "csrf_token", "label": {"field_id": "csrf_token", "text": "Csrf Token"}, "name": "csrf_token", "process_errors": [], "raw_data": [], "short_name": "csrf_token", "type": "CSRFTokenField", "widget": "hidden"},
							{"data": false, "default": false, "description": "", "errors": [], "filters": [], "flags": {}, "id": "remember", "label": {"field_id": "remember", "text": "Remember Me"}, "name": "remember", "process_errors": [], "raw_data": [], "short_name": "remember", "type": "BooleanField", "widget": "checkbox"},
							{"data": false, "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "submit", "label": {"field_id": "submit", "text": "Login"}, "name": "submit", "process_errors": [], "raw_data": [], "short_name": "submit", "type": "SubmitField", "widget": "submit"},
							{"data": "", "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "next", "label": {"field_id": "next", "text": "Next"}, "name": "next", "process_errors": [], "raw_data": [], "short_name": "next", "type": "HiddenField", "widget": "hidden"},
							{"data": "test", "default": null, "description": "", "errors": ["Invalid password"], "filters": [], "flags": {}, "id": "password", "label": {"field_id": "password", "text": "Password"}, "name": "password", "process_errors": [], "raw_data": ["test"], "short_name": "password", "type": "PasswordField", "widget": "password"},
							{"data": "test@realize.pe", "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "email", "label": {"field_id": "email", "text": "Email Address"}, "name": "email", "process_errors": [], "raw_data": ["test@realize.pe"], "short_name": "email", "type": "TextField", "widget": "text"}
						] });
					}
			...
			$httpBackend.whenGET(/\/api\/v1\/register/)
				.respond(function (url, data, headers) {
					return ret.authed({
						...
						success: {"csrf_token": null, "fields": [
							{"current_token": null, "data": null, "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "csrf_token", "label": {"field_id": "csrf_token", "text": "Csrf Token"}, "name": "csrf_token", "process_errors": [], "short_name": "csrf_token", "type": "CSRFTokenField", "widget": "hidden"},
							{"data": null, "default": null, "description": "", "errors": [], "filters": [], "flags": {"required": true }, "id": "password", "label": {"field_id": "password", "text": "Password"}, "name": "password", "process_errors": [], "short_name": "password", "type": "PasswordField", "widget": "password"},
							{"data": null, "default": null, "description": "", "errors": [], "filters": [], "flags": {"required": true }, "id": "email", "label": {"field_id": "email", "text": "Email Address"}, "name": "email", "process_errors": [], "short_name": "email", "type": "TextField", "widget": "text"},
							{"data": false, "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "submit", "label": {"field_id": "submit", "text": "Register"}, "name": "submit", "process_errors": [], "short_name": "submit", "type": "SubmitField", "widget": "submit"}
						] }
					});
				});
			...
			$httpBackend.whenPOST(/\/api\/v1\/register/)
				.respond(function (url, data, headers) {
					if (mocks.user.hashkey === data.user.hashkey) {
						return ret.fail({"csrf_token": null, "fields": [
							{"current_token": null, "data": "", "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "csrf_token", "label": {"field_id": "csrf_token", "text": "Csrf Token"}, "name": "csrf_token", "process_errors": [], "raw_data": [], "short_name": "csrf_token", "type": "CSRFTokenField", "widget": "hidden"},
							{"data": "testtest", "default": null, "description": "", "errors": [], "filters": [], "flags": {"required": true }, "id": "password", "label": {"field_id": "password", "text": "Password"}, "name": "password", "process_errors": [], "raw_data": ["testtest"], "short_name": "password", "type": "PasswordField", "widget": "password"},
							{"data": "test@realize.pe", "default": null, "description": "", "errors": ["test@realize.pe is already associated with an account."], "filters": [], "flags": {"required": true }, "id": "email", "label": {"field_id": "email", "text": "Email Address"}, "name": "email", "process_errors": [], "raw_data": ["test@realize.pe"], "short_name": "email", "type": "TextField", "widget": "text"},
							{"data": false, "default": null, "description": "", "errors": [], "filters": [], "flags": {}, "id": "submit", "label": {"field_id": "submit", "text": "Register"}, "name": "submit", "process_errors": [], "raw_data": [], "short_name": "submit", "type": "SubmitField", "widget": "submit"}
						] });
					}
					return ret.success({"user": {"hashkey": mocks.user.hashkey, "id": mocks.user.id, "token": mocks.user.token } });
				});
